    ...
    <div className="relative flex items-center bg-white border-b border-amber-200/60 py-2 sm:py-3">
      ...
      >
        ...
        <Button
          ...
          className="flex items-center gap-1 sm:gap-1.5 whitespace-nowrap border-amber-200 hover:border-indigo-300 hover:bg-indigo-50 shadow-atlas-sm text-xs sm:text-sm px-2.5 sm:px-3 py-1.5 rounded-full"
        >
            ...
            <Button
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'border-amber-200/60 hover:border-amber-300 hover:bg-amber-50'
              )}
            >
