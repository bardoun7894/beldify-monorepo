...
export default function HomeContent({
	...
	const gridCategories =
		departments && departments.length > 0 ? departments : categories;

	// Track which journal article images failed
	const [journalImgError, setJournalImgError] = useState<
          ...
          the site header (z-40) but above cards/images. */}
					...
					>
						...
						>
							<span className="flex h-14 w-14 lg:h-[68px] lg:w-[68px] items-center justify-center rounded-full bg-indigo-50 ring-1 ring-indigo-200 transition-all duration-200 group-hover:bg-indigo-700 group-hover:ring-indigo-700 group-hover:-translate-y-0.5">
								<ArrowRight
									className="h-5 w-5 text-indigo-700 group-hover:text-white rtl:rotate-180 transition-colors duration-200"
									aria-hidden="true"
								/>
							</span>
							<span
								className={`text-[11px] font-medium text-indigo-700 text-center leading-tight line-clamp-2 max-w-[84px] ${isArabicScript ? "font-arabic" : ""}`}
							>
				...
				<div className="flex items-end justify-between mb-10">
					<div>
						...
						<p className="mt-1 text-sm text-gray-500">
							{t("home.categories.subtitle", "Browse the souk")}
						</p>
					</div>
					<Link
						href="/categories"
					...
					<div className="py-16 text-center rounded-2xl bg-gray-50 ring-1 ring-gray-200">
						...
						<p className="text-sm text-gray-600">
							{t(
								...
								"Categories will appear here once the catalogue is live.",
							)}
						</p>
					</div>
				) : (
							...
							{gridCategories.map((c, idx) => {
								...
								return (
									<div
										key={c.id}
										className={
											featured ? "h-full sm:col-span-2 lg:col-span-2" : "h-full"
										}
									>
										<CategoryCard
											id={c.id}
					...
					<div className="relative overflow-hidden rounded-2xl bg-indigo-950 ring-1 ring-white/10 shadow-atlas-lg">
						...
						<div className="relative px-8 py-16 sm:px-12 sm:py-20">
							...
							<p className="mt-4 text-indigo-200 text-base max-w-sm">
								{t(
									"home.offers.editorial_description",
									"Our finest ready-to-wear Moroccan creations — seasonal caftans and djellabas.",
								)}
							</p>
							<Link
								href="/products"
								...
								aria-label={t(
									"home.offers.cta_shop_collection",
									"Shop the collection",
								)}
							>
					...
					<div className="relative overflow-hidden rounded-2xl bg-gray-50 ring-1 ring-gray-200 shadow-atlas-md">
						...
						<div className="relative px-8 py-16 sm:px-12 sm:py-20">
							...
							<p className="mt-4 text-gray-600 text-base max-w-sm">
								{t(
									"home.offers.festive_description",
			...
			<section className="relative isolate overflow-hidden bg-indigo-950 text-white">
				...
				<div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-20 grid lg:grid-cols-2 gap-12 items-center">
					...
					<ol
						className="space-y-4"
						aria-label={t("home.tailoring.steps_label", "How tailoring works")}
					>
						{[
							{
								step: t("home.tailoring.step1_title", "Pick your tailor"),
								detail: t(
									"home.tailoring.step1_detail",
									"Browse verified ateliers across Tetouan, Fez, Casablanca.",
								),
							},
							{
								step: t("home.tailoring.step2_title", "Send measurements"),
								detail: t(
									"home.tailoring.step2_detail",
									"Use our guided form or upload an existing pattern.",
								),
							},
							{
								step: t("home.tailoring.step3_title", "Receive your piece"),
								detail: t(
									"home.tailoring.step3_detail",
									"Hand-finished and shipped to your door in 2–4 weeks.",
								),
							},
						].map(({ step, detail }, i) => (
							<li
								key={step}
								className="flex gap-4 rounded-xl bg-indigo-900 ring-1 ring-white/10 px-5 py-4"
							>
								<span
			...
			<section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
				<div className="flex items-end justify-between mb-10">
					<div>
						...
						<p className="mt-1 text-sm text-gray-500">
							{t(
								"home.openSouk.subtitle",
								"Open briefs waiting for offers — be the first to respond",
							)}
						</p>
					</div>
					<Link
				...
				{openSoukPosts.length === 0 ? (
					...
					<div className="space-y-8">
						...
						<p className="text-sm text-gray-500 text-center">
							{t(
								"home.openSouk.emptyBody",
								"No open briefs yet. Be the first to post one and let ateliers come to you.",
							)}
						</p>
						...
						>
							{[
								...
								>
									...
									<h3
										className="text-sm font-semibold text-gray-700 leading-snug mb-2"
										dir="rtl"
									>
										{card.title}
									</h3>
			...
			<section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
				<div className="flex items-end justify-between mb-10">
					<div>
						...
						>
							<span dir="rtl" lang="ar" className="font-arabic">
								{t("home.ateliers.headingAr", "ورشات مختارة")}
							</span>
						</h2>
						<p className="mt-1 text-sm text-gray-500">
							{t("home.ateliers.subtitle", "Curated ateliers")}
						</p>
					</div>
					<Link
						href="/shops"
					...
					>
						{t("home.ateliers.view_all", "All ateliers")}{" "}
						<ArrowRight className="h-4 w-4" aria-hidden="true" />
					</Link>
				</div>
				...
				<div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                    ...
                    rather than stamped on every card unconditionally (storefront audit P1-C). */}
							...
							<div className="p-4">
								...
								<p className="mt-1.5 text-xs text-indigo-700 font-medium">
									{a.specialty}
								</p>
							</div>
						</Link>
				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
					<div className="flex items-end justify-between mb-10">
						<div>
							...
							>
								<span dir="rtl" lang="ar" className="font-arabic">
									{t("home.journal.headingAr", "المجلة")}
								</span>
							</h2>
							<p className="mt-1 text-sm text-gray-500">
								{t("home.journal.subtitle", "Stories from the atelier")}
							</p>
						</div>
						<Link
							href="/community"
							className="hidden sm:inline-flex items-center gap-1 text-sm font-semibold text-indigo-700 hover:text-indigo-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-700/30 rounded"
						>
							{t("home.journal.view_all", "All stories")}{" "}
							<ArrowRight className="h-4 w-4" aria-hidden="true" />
						</Link>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-5">
						{journal.map((a, idx) => {
							...
							return (
								...
								>
									<div
										className={`relative overflow-hidden ${idx === 0 ? "md:flex-1" : "aspect-[16/10]"}`}
									>
										{journalFallback ? (
											/* Neutral fallback when journal image is dead or missing */
											<div className="absolute inset-0 bg-gray-100 flex items-center justify-center">
												<span
													className="text-4xl font-bold text-indigo-700/20 select-none"
													aria-hidden="true"
												>
									...
									<div className="p-5">
										...
										<p className="mt-4 text-xs text-gray-500">
											...
											{t("home.journal.read_time_suffix", "read")}
										</p>
									</div>
								</article>
							);
					...
					<div>
						...
						>
							...
							<span className="text-amber-400">
								{t("home.seller.headline_line2", "Reach Morocco and beyond.")}
							</span>
						</h2>
						<p className="text-indigo-200 text-base mb-8 max-w-md leading-relaxed">
							{t(
								"home.seller.description",
					...
					<div className="space-y-4">
						...
						<div className="rounded-2xl bg-indigo-900 ring-1 ring-white/10 px-6 py-6">
							<p className="text-xs uppercase tracking-wide text-indigo-300/80">
								{t("home.seller.stat_range_label", "Typical listing range")}
							</p>
							<p
							...
							>
								<span className="currency-mad">
									{t("home.seller.stat_range_value", "299–5,999 MAD")}
								</span>
							</p>
							<p className="text-xs text-indigo-300/70 mt-1">
								{t(
									"home.seller.stat_range_hint",
									"What sellers typically charge",
								)}
							</p>
						</div>
						...
						<div className="grid grid-cols-2 gap-4">
							{[
								...
								{
									value: t("home.seller.stat_sellers_value", "Growing"),
									labelKey: "home.seller.stat_sellers_label",
									labelFallback: "Seller community",
								},
								{
									value: t("home.seller.stat_protection_value", "14-day"),
									labelKey: "home.seller.stat_protection_label",
									labelFallback: "Buyer protection",
								},
							].map((s) => (
								<div
									key={s.labelKey}
				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
					...
					<div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-0 sm:divide-x divide-gray-200">
						{(
							[
								{
									labelKey: "home.trust.free_delivery",
									labelFallback: "Free delivery +500 MAD",
									subKey: "home.trust.delivery_sub",
									subFallback: "In major cities in 48 hours",
									Icon: Truck,
								},
								{
									labelKey: "home.trust.returns",
									labelFallback: "14-day returns",
									subKey: "home.trust.returns_sub",
									subFallback: "No fees, no hassle",
									Icon: RotateCcw,
								},
								{
									labelKey: "home.trust.verified_sellers",
									labelFallback: "Verified sellers",
									subKey: "home.trust.sellers_sub",
									subFallback: "Workshops inspected one by one",
									Icon: ShieldCheck,
								},
								{
									labelKey: "home.trust.support",
									labelFallback: "Support AR / FR / EN",
									subKey: "home.trust.support_sub",
									subFallback: "WhatsApp, phone, email",
									Icon: Headphones,
								},
							] as const
						).map(({ labelKey, labelFallback, subKey, subFallback, Icon }) => (
							<div
								key={labelKey}
...
function OccasionGrid({ categories, isArabicScript }: OccasionGridProps) {
	...
	const occasions = [
		...
		},
		{
			...
			image:
				"https://pro.beldify.com/storage/categories/category_5_womens-djellaba.png",
		},
		{
			...
			<div className="flex items-end justify-between mb-8">
				<div>
					...
					<div className="inline-flex items-center gap-2 mb-3">
						...
						/>
						<span
							className={`text-xs text-amber-700 font-medium ${isArabicScript ? "font-arabic" : "uppercase tracking-[0.18em]"}`}
						>
