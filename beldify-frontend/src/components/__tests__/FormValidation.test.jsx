...
function TestLoginForm({ onSubmit, isLoading = false, formError = '', }) {
    const { register, handleSubmit, formState: { errors }, } = useForm();
    return (<form onSubmit={handleSubmit(onSubmit)} data-testid="login-form">
      {formError && (<div className="error-message" role="alert" data-testid="form-error">
          {formError}
        </div>)}
    ...
    })} type="email" id="email" data-testid="email-input"/>
        {errors.email && (<p className="field-error" data-testid="email-error">
      ...
      <div>
        ...
        {errors.password && (<p className="field-error" data-testid="password-error">
...
function TestRegistrationForm({ onSubmit, isLoading = false, formError = '', }) {
    const { register, handleSubmit, formState: { errors }, } = useForm();
    return (<form onSubmit={handleSubmit(onSubmit)} data-testid="registration-form">
      {formError && (<div className="error-message" role="alert" data-testid="form-error">
          {formError}
        </div>)}
      ...
      <div>
        ...
        {errors.username && (<p className="field-error" data-testid="username-error">
...
describe('FormValidation', () => {
    ...
    describe('Password Strength Validation', () => {
        ...
        it('should show error for password without uppercase in registration form', async () => {
            ...
            await userEvent.click(screen.getByTestId('submit-btn'));
            await waitFor(() => {
                expect(screen.getByTestId('password-error')).toHaveTextContent('Password must contain an uppercase letter');
            });
        });
        it('should show error for password without number in registration form', async () => {
            ...
            await userEvent.click(screen.getByTestId('submit-btn'));
            await waitFor(() => {
                expect(screen.getByTestId('password-error')).toHaveTextContent('Password must contain a number');
            });
        });
    ...
    describe('Field-Level Error Display', () => {
        it('should display error message under the correct field', async () => {
            ...
            await waitFor(() => {
                ...
                expect((_a = emailInput.parentElement) === null || _a === void 0 ? void 0 : _a.contains(emailError)).toBe(true);
            });
        });
