...
// ── Inline bar chart ──────────────────────────────────────────────────────────
function EarningsChart({ byDay, numLocale }: { byDay: Array<{ date: string; revenue: number }>; numLocale: string }) {
          ...
          <div className="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100">
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                {t('seller.earnings.chart_sub', 'Showing last {{period}} days in {{currency}}', {
            ...
            <div className="px-5 pt-4 pb-6">
              <EarningsChart byDay={earnings.by_day} numLocale={numLocale} />
              {/* Axis labels */}
