...
import { registerSeller, SellerRegisterPayload } from '@/services/sellerService';
...
export default function SellerSignupPage() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.store_name.trim()) {
      setErrorMsg(t('seller.register.store_name_required', 'Store name is required'));
      return true;
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(err.message || t('seller.register.error_generic', 'Something went wrong. Please try again.'));
    } finally {
      ...
      <div className="bg-indigo-950 py-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="mt-3 text-indigo-200 text-sm max-w-xl mx-auto">
            {t('seller.signup.subtitle', 'One form. Your account + store application, reviewed within 3–5 business days.')}
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl ring-1 ring-gray-200 p-8 shadow-atlas-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <label htmlFor="full_name_en" className="block text-sm font-medium text-gray-700 mb-1.5">
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1.5">
                ...
                <span className="text-gray-400 font-normal text-xs ms-1">({t('common.optional', 'optional')})</span>
              </label>
              <input
                type="email"
                id="email"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder={t('seller.register.description_placeholder', 'Describe your products, craftsmanship, and what makes your store unique...')}
            ...
            <div>
              ...
              >
                ...
                <span className="text-sm text-gray-600">
                  {form.logo ? form.logo.name : t('seller.register.logo_hint', 'JPG or PNG, max 2 MB')}
                </span>
                <input
                  type="file"
                  id="logo"
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link href="/login?redirect=/seller/register" className="text-indigo-700 hover:text-indigo-900 font-medium">
