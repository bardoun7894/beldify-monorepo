...
/** Review step: shows generated content and lets seller Apply or Discard. */
...
export default function SellerNewProductPage() {
  ...
  useEffect(() => {
    ...
    getSellerCredits()
      ...
      .catch(() => {
        // Non-fatal — AI buttons just show cost=? if credits endpoint fails
      });
  }, [isAuthenticated]);
