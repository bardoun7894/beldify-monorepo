    ...
    <main className="min-h-screen bg-[#faf9f7]">
      <div className="mx-auto max-w-2xl px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div
            role="alert"
            className="flex flex-col items-center gap-4 rounded-2xl border border-rose-200 bg-rose-50 px-6 py-10 text-center"
          >
            <p className="text-sm font-medium text-rose-700">
              {t('notifications.page.loadError', 'Could not load notifications. Check your connection and try again.')}
            </p>
            <button
              onClick={() => load(currentPage)}
              className="flex items-center gap-1.5 rounded-full bg-rose-100 px-4 py-2 text-xs font-semibold text-rose-700 hover:bg-rose-200 transition"
            >
