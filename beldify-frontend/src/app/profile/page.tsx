...
import { User, Lock, Settings, BookUser, Store } from "lucide-react";
				...
				<div className="max-w-5xl mx-auto">
					...
					>
						...
						<div className="p-5 sm:p-7 bg-white">
							...
							{/* Seller dashboard shortcut — shown only for dual-role sellers (customer + store_owner) */}
							{user.is_seller && (
								<div className="mt-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-xl border border-amber-200 bg-gradient-to-r from-amber-50 to-amber-50/50 px-4 py-3">
									<div className="flex items-center gap-3">
										<span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-amber-100 ring-2 ring-amber-200">
											<Store
										...
										<div className="min-w-0">
											<p className="text-sm font-semibold text-indigo-900 truncate">
												{t("seller.shortcut_title", {
													ns: "common",
													defaultValue: "Seller Dashboard",
												})}
											</p>
											<p className="text-xs text-gray-500 truncate">
												{t("seller.shortcut_body", {
													ns: "common",
													defaultValue:
						...
						<div className="grid md:grid-cols-12">
							...
							<div className="md:col-span-3 bg-amber-50 p-4 border-e border-amber-100">
								...
								<div className="flex gap-2 overflow-x-auto pb-1 md:hidden snap-x snap-mandatory">
									{(
										["general", "security", "preferences", "addresses"] as const
									).map((tab) => {
